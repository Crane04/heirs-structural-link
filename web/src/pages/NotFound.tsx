    ...
    <div className="min-h-screen bg-navy text-white">
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="hs-card p-10 md:p-14 text-center">
          <div className="mx-auto w-16 h-16 rounded-2xl border border-teal/30 bg-surface2/40 flex items-center justify-center text-tealL text-2xl">
          ...
          <div className="mt-8 text-6xl sm:text-7xl font-bold tracking-tight">
            404 <span className="text-tealL">Page Not Found</span>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
            {[
              ...
              <div key={x.k} className="hs-card p-5">
                <div className="text-[11px] tracking-widest uppercase text-white/40">{x.k}</div>
                <div className="mt-2 font-semibold text-white/80">{x.t}</div>
              </div>
            ))}
          </div>
        </div>

        <div className="mt-10 text-xs text-white/35 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="font-semibold text-white/60">Heirs Structural‑Link AI</div>
