      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="relative w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 120 120">
                <circle cx="60" cy="60" r="54" fill="none" stroke="rgba(6,20,37,0.10)" strokeWidth="8" />
                <circle
                  cx="60"
                  cy="60"
                  r="54"
                  ...
                  className="transition-all duration-700 text-ink"
                />
              </svg>
              <div className="absolute inset-0 flex items-center justify-center">
                <div>
                  <div className="text-4xl font-bold">{percent}%</div>
                  <div className="text-[11px] tracking-widest uppercase text-ink/50 mt-1">Analyzing</div>
                </div>
              </div>
            </div>

            <h1 className="text-3xl font-bold tracking-tight mt-7">Vehicle Structural Diagnostics</h1>
            <p className="text-ink/55 text-sm mt-3 max-w-lg">
        ...
        <div className="flex flex-col gap-6">
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-[11px] tracking-widest uppercase text-ink/45 mt-1">
                  Engine: HS‑LINK v2.4
                </div>
              </div>
              <span className="hs-chip">
                ...
                return (
                  <div
                    ...
                    className={[
                      ...
                      isActive ? 'border-ink/20 bg-surface2/40' : isDone ? 'border-border/50 bg-surface/30' : 'border-border/40 bg-surface/20 opacity-60',
                    ].join(' ')}
                  >
                    <div
                      className={[
                        'w-10 h-10 rounded-xl flex items-center justify-center border text-sm font-bold',
                        isDone ? 'border-ink/20 bg-ink/5 text-ink' : isActive ? 'border-ink/20 bg-ink/5 text-ink' : 'border-border/50 text-ink/40',
                      ].join(' ')}
                    >
                      {isDone ? <Icon name="check" className="w-5 h-5" /> : i + 1}
                    </div>
                    <div className="flex-1">
                      <div className="text-sm font-semibold text-ink/90">{s.label}</div>
                      <div className="text-[11px] tracking-widest uppercase text-ink/40 mt-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-4">
            <Card className="p-5">
              <div className="text-2xl font-bold text-ink">2,840</div>
              <div className="text-[11px] tracking-widest uppercase text-ink/45 mt-1">Point cloud density</div>
            </Card>
            <Card className="p-5">
              <div className="text-2xl font-bold text-ink">0.02mm</div>
              <div className="text-[11px] tracking-widest uppercase text-ink/45 mt-1">Precision threshold</div>
            </Card>
            <Card className="p-5">
              <div className="text-2xl font-bold text-ink">GPU</div>
              <div className="text-[11px] tracking-widest uppercase text-ink/45 mt-1">Compute instance</div>
            </Card>
          </div>
        </div>

        <div className="lg:col-span-3 text-center text-xs text-ink/35">
